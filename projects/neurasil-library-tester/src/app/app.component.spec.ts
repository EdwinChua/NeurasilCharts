...
describe('AppComponent', () => {
    ...
    let mockUtilsService: MockedObject<UtilsService>;
    ...
    beforeEach(async () => {
        mockUtilsService = {
            generateSampleData: vi.fn().mockName("UtilsService.generateSampleData"),
            csvToJson: vi.fn().mockName("UtilsService.csvToJson")
        };
        mockUtilsService.generateSampleData.mockReturnValue(fakeSampleData);
        mockUtilsService.csvToJson.mockReturnValue(fakeSampleData);

        await TestBed.configureTestingModule({
            imports: [AppComponent, MockNeurasilDataFilterPipe],
            providers: [{ provide: UtilsService, useValue: mockUtilsService }],
        })
        .overrideComponent(AppComponent, {
            set: { imports: [MockNeurasilDataFilterPipe], schemas: [NO_ERRORS_SCHEMA] }
        })
        .compileComponents();
    });
